...
public class NeedScanFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        RecyclerViewAdapterNeedScan adapter = new RecyclerViewAdapterNeedScan(items);
        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(getContext());
        mBinding.rvNeedScanItems.setHasFixedSize(true);
        mBinding.rvNeedScanItems.setLayoutManager(layoutManager);
        mBinding.rvNeedScanItems.setAdapter(adapter);
